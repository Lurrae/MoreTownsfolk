...
namespace MoreTownsfolk.Tiles
{
	public class CrimsonPylonTile : ModPylon
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			Main.LocalPlayer.cursorItemIconID = ItemType<TeleportationPylonCrimson>();
		}
		...
		public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale)
		{
			...
			DefaultMapClickHandle(mouseOver, pylonInfo, GetInstance<TeleportationPylonCrimson>().DisplayName.Key, ref mouseOverText);
		}
	}
}